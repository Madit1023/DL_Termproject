...
model_num = 6
num_epoch = 60
model_name = 'gaussian5'
ten_crop = True
seed_num = [0,1,2,37,47,57]
...
for i in range(model_num):
    ...
    model.load_state_dict(torch.load(f"./weights/%s_%d_%d.pth" % (model_name, num_epoch, seed_num[i])))  # Load the trained weights
